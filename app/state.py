...
STATUS_LABELS = {
	"pendente": ("❌", "pendente"),
	"em_andamento": ("⚠️", "próxima etapa recomendada"),
	"concluido": ("✅", "concluído"),
}

FLOW_STAGES = [
	("base_mestre_status", "Base Mestre"),
	("importacao_status", "Importação"),
	("consolidacao_status", "Consolidação"),
	("analises_status", "Análises"),
	("exportacao_status", "Exportação"),
]
...
def render_system_status() -> None:
	...
	with st.container(border=True):
		...
		st.caption("O sistema indica a próxima etapa recomendada com base no fluxo operacional.")
