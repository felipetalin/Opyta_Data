# --- SCRIPT DE MIGRAÇÃO - FITOPLÂNCTON (V5.3 - Engine Central Padronizado) ---
...
def migrar_dados(connection, id_projeto, df_capa, df_pontos, df_esforco, df_resultados):
            ...
            resultados_records.append(
                {
                    ...
                    "densidade_cel_ml": row.get("Numero_de_Individuos"),
                    "biovolume_mm3_L": row.get("Biovolume_mm3_L"),
                    "tipo_amostragem": row.get("Tipo_de_Amostragem"),
                }
            )
        elif not id_especie:
    ...
    if resultados_records:
        query_resultados = text(
            ...
            DO UPDATE SET
                densidade_cel_ml = EXCLUDED.densidade_cel_ml,
                biovolume_mm3_L = EXCLUDED.biovolume_mm3_L,
                tipo_amostragem = EXCLUDED.tipo_amostragem
            """
        )
