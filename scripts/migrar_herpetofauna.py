...
# --- CONFIGURAÇÕES ---
ARQUIVO_EXCEL = sys.argv[1] if len(sys.argv) > 1 else "projeto_herpetofauna_real.xlsx"
GRUPO_BIOLOGICO_ALVO = sys.argv[2] if len(sys.argv) > 2 else "Herpetofauna"
...
def main():
    ...
    try:
        ...
        logger.error("ERRO DURANTE A MIGRAÇÃO. A TRANSAÇÃO FOI REVERTIDA (ROLLBACK)")
