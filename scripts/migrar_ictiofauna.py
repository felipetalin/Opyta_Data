...
def limpar_dados_da_campanha(connection, id_projeto, df_pontos_da_planilha):
    ...
    print(
        f"\n-> Verificando e limpando dados ANTIGOS de {GRUPO_BIOLOGICO_ALVO} "
    ...
    if not ids_campanha_para_limpar:
        print("   -> Campanhas são novas no banco, nenhuma limpeza necessária.")
        return
